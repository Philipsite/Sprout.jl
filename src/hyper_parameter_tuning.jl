...
"""
function run_hyperparam_tuning(n_layers::Vector{<:Integer}, n_neurons::Vector{<:Integer},
                               train_data::Tuple{<:AbstractArray, <:AbstractArray}, val_data::Tuple{<:AbstractArray, <:AbstractArray},
                               loss::Function, max_epochs::Integer, metrics::Vector{<:Function};
